...
inv vm.start $remote_flag --virtio-nic --action=${action} --virtio-nic-vhost --virtio-iommu --extra-cmdline swiotlb=524288,force
...
inv vm.start $remote_flag --type snp --virtio-nic --action=${action} --virtio-nic-vhost --extra-cmdline idle=poll --name-extra -poll
...
inv vm.start $remote_flag --type snp --virtio-nic --action=${action} --virtio-nic-vhost --extra-cmdline cpuidle_haltpoll.force=Y --name-extra -hpoll
