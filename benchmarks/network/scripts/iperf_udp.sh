...
inv vm.start --type intel $remote_flag --virtio-nic --virtio-nic-vhost --action=${action} --virtio-iommu --extra-cmdline swiotlb=524288,force
...
inv vm.start $remote_flag --type tdx --virtio-nic --virtio-nic-vhost --action=${action} --extra-cmdline idle=poll --name-extra -poll
...
inv vm.start $remote_flag --type tdx --virtio-nic --virtio-nic-vhost --action=${action} --extra-cmdline cpuidle_haltpoll.force=Y --name-extra -hpoll
...
inv vm.start $remote_flag --type intel --virtio-nic --virtio-nic-vhost --action=${action} --extra-cmdline idle=poll --name-extra -poll
...
inv vm.start $remote_flag --type intel --virtio-nic --virtio-nic-vhost --action=${action} --extra-cmdline cpuidle_haltpoll.force=Y --name-extra -hpoll
